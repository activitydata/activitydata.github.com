...
var TREE_TPL = {
	...
	// icons - root	
	'icon_48':'Res/tree/house.png', // root icon normal
	'icon_52':'Res/tree/house_go.png', // root icon selected
	'icon_56':'Res/tree/house.png', // root icon opened
	'icon_60':'Res/tree/house_go.png', // root icon selected opened


	// icons - junctions	
	'icon_2':'Res/tree/empty.gif', // junction for leaf
	'icon_3':'Res/tree/empty.gif', // junction for last leaf
	'icon_18':'Res/tree/add.png', // junction for closed node
	'icon_19':'Res/tree/add.png', // junctioin for last closed node
	'icon_26':'Res/tree/delete.png', // junction for opened node
	'icon_27':'Res/tree/delete.png', // junctioin for last opended node
